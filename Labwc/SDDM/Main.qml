...
Rectangle {
        ...
        ColumnLayout {
            ...
            Item {
                ...
                Rectangle {
                    ...
                    border.color: "#886dbf"; border.width: 2
                }
            }
            ...
            Text {
                ...
                color: "#a286d2"; font.pixelSize: 18; font.weight: Font.Medium
            }
            ...
            Rectangle {
                ...
                color: "#1a050008"
                border.color: passwordInput.activeFocus ? "#9f7aea" : "#886dbf"
                ...
                TextInput {
                    ...
                    color: "#a286d2"; font.pixelSize: 14
                    verticalAlignment: TextInput.AlignVCenter
                    Text {
                        anchors.fill: parent
                        text: "Senha"; color: "#66a286d2"; font.pixelSize: 14
            ...
            Item {
                ...
                Rectangle {
                    id: sessionBox
                    anchors.fill: parent
                    color: sessionBoxArea.containsMouse ? "#1a886dbf" : "#1a050008"
                    border.color: sessionDropdown.visible ? "#9f7aea" : "#886dbf"
                    border.width: 1
                    radius: 8
            ...
            Rectangle {
                Layout.fillWidth: true; height: 40
                color: loginArea.pressed ? "#33886dbf" : loginArea.containsMouse ? "#1a886dbf" : "transparent"
                border.color: "#886dbf"; border.width: 1; radius: 8
                Behavior on color { ColorAnimation { duration: 150 } }
                Text { anchors.centerIn: parent; text: "Entrar"; color: "#a286d2"; font.pixelSize: 14 }
                MouseArea {
            ...
            RowLayout {
                ...
                Repeater {
                    ...
                    delegate: Text {
                        ...
                        color: pArea.containsMouse ? "#a286d2" : "#66a286d2"
                        Behavior on color { ColorAnimation { duration: 150 } }
                        MouseArea {
    ...
    Column {
        ...
        Text {
            ...
            color: "#a286d2"; font.pixelSize: 32; font.weight: Font.Light
        ...
        Text {
            anchors.right: parent.right; color: "#66a286d2"; font.pixelSize: 14
